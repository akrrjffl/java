...
public class Q {
	...
	public static void main(String[] args) {
		...
		while(true) {
			System.err.println("=====은행=====");
			System.out.println("1.계좌생성 2.입금 3.출금 4.계좌목록 5.종료");
			...
			if(menu == 1) {
				...
				// 입금 할 계좌번호, 입금금액 입력받고 입금 할 계좌를 account에서 찾아 입금
				...
				// 출금 할 계좌번호, 출금금액 입력받고 입금 할 계좌를 account에서 찾아 출금
				// 잔액부족 표시
